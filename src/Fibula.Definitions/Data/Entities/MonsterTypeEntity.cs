...
namespace Fibula.Definitions.Data.Entities
{
    ...
    public class MonsterTypeEntity : CreatureEntity
    {
        ...
        /// </summary>
        public override Outfit OriginalOutfit
        {
            get => this.outfit;
            ...
            set
            {
                if (this.Locked)
                {
                    throw new InvalidOperationException($"Unable to set {nameof(this.OriginalOutfit)}. The {nameof(MonsterTypeEntity)} is locked and cannot be altered.");
                }
